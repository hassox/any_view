...
The AnyView gem provides helpers for common web related view rendering.  The anyView gem is a collection of mixins that work together to provide tags, forms asset paths and more.  AnyView is based hevily on the Padrino framework helpers module.
